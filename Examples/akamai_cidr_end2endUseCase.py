...
parser.add_argument('--filename', default='akamai_nov13_table.csv',
                    type=str)
...
# For Kiva partner table
# cctypes = ['continuous','multinomial','continuous','multinomial','continuous',
#            'continuous','continuous','continuous','continuous','continuous',
#            'multinomial']

# # For akamai table
cctypes = ['continuous',
           'multinomial','continuous','continuous','multinomial','multinomial',
...
if cachedState == ' ':
    ...
    saved_dict = {'T':T, 'M_c':M_c, 'X_L_list':X_L_list, 'X_D_list': X_D_list}
    pkl_filename = 'kiva_flat_table_model_{!s}.pkl.gz'.format('last')
    f_utils.pickle(saved_dict, filename = pkl_filename)
else:
